 ...
 */
  ...
  */
 public class QuickSpaceSettings extends CollapsingToolbarBaseActivity
     ...
     private boolean startPreference(String fragment, Bundle args, String key) {
         ...
         if (f instanceof DialogFragment) {
             ...
             startActivity(new Intent(this, QuickSpaceSettings.class)
     ...
     public boolean onPreferenceStartScreen(PreferenceFragmentCompat caller, PreferenceScreen pref) {
         ...
         return startPreference(getString(R.string.quickspace_title_settings), args, pref.getKey());
     }
      ...
      */
     public static class QuickSpaceSettingsFragment extends PreferenceFragmentCompat {
